class OrdersController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @order.update(order_params)
        format.html { redirect_to orders_path, notice: 'Thanks for leaving feedback.' }
  ...
  private
    ...
    def order_params
      params.require(:order).permit(:feedback_comment, :feedback_rating, :buyer_id, :seller_id, :item_id)
    end
end
